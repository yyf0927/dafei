...
public class ExecutorDelivery {
    ...
    private static class ResponseDeliveryRunnable2 implements Runnable {
        ...
        public static ResponseDeliveryRunnable2 response(HttpCallback modelCallback, BaseRequest request, HttpResponse response, Exception e) {
            return new ResponseDeliveryRunnable2(modelCallback, request, response, e);
        }
